...
public class ScanTest extends SimpleDbTestBase {
    ...
    /** Scan 1-4 columns. */
    @Test public void testSmall() throws IOException, DbException, TransactionAbortedException, Exception {
    ...
    @Test public void testRewind() throws IOException, DbException, TransactionAbortedException, Exception {
        ArrayList<ArrayList<Integer>> tuples = new ArrayList<ArrayList<Integer>>();
     ...
     * @throws DbException */
    @Test public void testCache() throws IOException, DbException, TransactionAbortedException, Exception {
